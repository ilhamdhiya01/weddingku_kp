                ...
                <div class="col-md-3">
                    <div class="card">
                        ...
                        <div class="card-right-2">
                            ...
                            <div class="price">
                                <a href="">
                                    <div class="price-list" id="menu-harga">
                            ...
                            <div class="top-menu desktop-v">
                                <div class="row justify-content-center">
                                    <div class="col-8">
                                        <div class="row">
                                            <div class="col-3">
                                                <a href="<?= base_url(); ?>login/vendors/profile_vendor"><i class="fas fa-shopping-bag"></i> Produk (21)</a>
                                            </div>
                                            <div class="col-3">
                                            ...
                                            <div class="col-3">
                                                <a href="<?= base_url(); ?>login/vendors/promo"><i class="fas fa-percent"></i> Promo</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
